# Robbin Bouwmeester
# Supervisors: prof. Sven Degroeve & prof. Lennart Martens
# 
...
#
# This code is used to evaluate CALLC tool used for LC retention time
# prediction. The code generates the plots used in the manuscript.
#
...
# Change to to the working directory instead of getwd()
main_dir <- getwd()
...
plot_learning_curves <- function(df,
                                 ...
                                 title="",
                                 xlab="Number of calibration analytes",
  ...
  if (percentage) {
    p<-ggplot(df, aes(x=as.factor(number_train), y=perf*100, fill = algo)) +
      geom_boxplot(position=position_dodge(0.6),width=0.65, outlier.size = 0.75) +
...
emf(file=file.path(main_dir,"figs/duplicate/lc/layer_1_comp_lc_mae.emf"), 
    width=6.5, 
    height=6, 
...
emf(file=file.path(main_dir,"figs/duplicate/lc/layer_comp_lc_mae.emf"), 
    width=6.5, 
    height=6, 
    pointsize=12,family="Arial",emfPlus=FALSE)
...
emf(file=file.path(main_dir,"figs/unique/lc/layer_1_unique_comp_lc_mae.emf"), 
    width=6.5, 
    height=6, 
    pointsize=12,family="Arial",emfPlus=FALSE)
...
emf(file=file.path(main_dir,"figs/unique/lc/layer_unique_comp_lc_mae.emf"), 
    width=6.5, 
    height=6, 
    pointsize=12,family="Arial",emfPlus=FALSE)
...
emf(file=file.path(main_dir,"figs/duplicate/lc/layer_1_comp_lc_r.emf"), 
    width=6.5, 
    height=6, 
    pointsize=12,family="Arial",emfPlus=FALSE)
...
emf(file=file.path(main_dir,"figs/duplicate/lc/layer_comp_lc_r.emf"), 
    width=6.5, 
    height=6, 
    pointsize=12,family="Arial",emfPlus=FALSE)
